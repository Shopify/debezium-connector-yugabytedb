...
/**
 * Rewritten metrics (io.debezium.metrics.Metrics) class to provide more customization and granular control over how we
 * initialize the metric related objects.
 * 
 */
public class YugabyteDBMetrics {
  ...
  protected YugabyteDBMetrics(CdcSourceTaskContext taskContext, String contextName) {
